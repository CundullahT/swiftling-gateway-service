...
public class SwiftlingGatewayServiceApplication {

    public static void main(String[] args) {

        SpringApplication app = new SpringApplication(SwiftlingGatewayServiceApplication.class);
        ...
        defaultProperties.put("info.application.name", "swiftling-gateway-service");
        defaultProperties.put("info.application.description", "Swiftling App's Gateway Service");
